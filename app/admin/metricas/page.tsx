            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  <div className="text-sm text-gray-500 mb-1">Tarjeta</div>
                  <div className="text-2xl font-semibold text-gray-900">
                    {generalMetrics.payment_methods?.card || 0}
                  </div>
                  {generalMetrics.totals.orders > 0 && (
                    <div className="text-xs text-gray-400 mt-1">
                      {((generalMetrics.payment_methods?.card || 0) / generalMetrics.totals.orders * 100).toFixed(1)}% del total
                    </div>
                  )}
                </div>
              </div>
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  <div className="text-sm text-gray-500 mb-1">Efectivo</div>
                  <div className="text-2xl font-semibold text-gray-900">
                    {generalMetrics.payment_methods?.cash || 0}
                  </div>
                  {generalMetrics.totals.orders > 0 && (
                    <div className="text-xs text-gray-400 mt-1">
                      {((generalMetrics.payment_methods?.cash || 0) / generalMetrics.totals.orders * 100).toFixed(1)}% del total
                    </div>
                  )}
                </div>
              </div>
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  <div className="text-sm text-gray-500 mb-1">Transferencia</div>
                  <div className="text-2xl font-semibold text-gray-900">
                    {generalMetrics.payment_methods?.transfer || 0}
                  </div>
                  {generalMetrics.totals.orders > 0 && (
                    <div className="text-xs text-gray-400 mt-1">
                      {((generalMetrics.payment_methods?.transfer || 0) / generalMetrics.totals.orders * 100).toFixed(1)}% del total
                    </div>
                  )}
                </div>
              </div>
